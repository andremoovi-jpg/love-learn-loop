...
import AdminConfiguracoesN8n from "./pages/admin/AdminConfiguracoesN8n";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/admin/integracoes/:id" element={
              <ProtectedRoute>
                <AdminRoute>
            ...
            <Route path="/admin/configuracoes-n8n" element={
              <ProtectedRoute>
                <AdminRoute>
                  <AdminConfiguracoesN8n />
                </AdminRoute>
              </ProtectedRoute>
            } />
