...
-- Dropar policy antiga de communities
DROP POLICY IF EXISTS "Users see communities of owned products" ON communities;

-- Criar nova policy que suporta ambos os cenários:
-- 1. Comunidades de produtos regulares (via product_id)
-- 2. Comunidades como produtos independentes (product_type='community')
CREATE POLICY "Users see owned communities"
ON communities
FOR SELECT
USING (
  -- Admins veem tudo
...
-- ============================================
-- FASE 3: Atualizar community_members RLS
-- ============================================
...
CREATE POLICY "Users join communities on product purchase"
